...
func (l *Logger) Infof(format string, v ...any) {
	...
	go l.logToServer("info", fmt.Sprintf(format, v...))
}

func (l *Logger) Info(v ...any) {
	log.Print(v...)
	_ = l.LogWriter.Info(fmt.Sprint(v...))
	go l.logToServer("info", fmt.Sprint(v...))
}

func (l *Logger) Errorf(format string, v ...any) {
	log.Printf(format, v...)
	_ = l.LogWriter.Error(fmt.Sprintf(format, v...))
	go l.logToServer("error", fmt.Sprintf(format, v...))
}

func (l *Logger) Error(v ...any) {
	log.Print(v...)
	_ = l.LogWriter.Error(fmt.Sprint(v...))
	go l.logToServer("error", fmt.Sprint(v...))
}

func (l *Logger) Warnf(format string, v ...any) {
	log.Printf(format, v...)
	_ = l.LogWriter.Warning(fmt.Sprintf(format, v...))
	go l.logToServer("warn", fmt.Sprintf(format, v...))
}

func (l *Logger) Warn(v ...any) {
	log.Print(v...)
	_ = l.LogWriter.Warning(fmt.Sprint(v...))
	go l.logToServer("warn", fmt.Sprint(v...))
}
